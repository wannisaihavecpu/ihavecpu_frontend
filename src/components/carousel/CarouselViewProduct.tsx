...
// ====================================================
export interface CarouselViewProductProps {
...
const CarouselViewProduct: FC<CarouselViewProductProps> = ({
  children,
  naturalSlideWidth,
  naturalSlideHeight,
  totalSlides,
    ...
    >
      ...
      {showArrow && (
        <Fragment>
          ...
          >
            <Icon variant="small">arrow-left</Icon>
          </IconButton>
...
CarouselViewProduct.defaultProps = {
  step: 1,
  totalSlides: 10,
  visibleSlides: 5,
  spacing: "1.5rem",
...
export default CarouselViewProduct;
