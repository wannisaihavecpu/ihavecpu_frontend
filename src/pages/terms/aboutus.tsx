...
<Card1>
       <H3>เกี่ยวกับ iHAVECPU</H3> 
         ...
         <p>ถ้าคุณชอบคอมพิวเตอร์ ราคาประหยัดต้อง iHAVECPU เท่านั้น ในการซื้อคอมพิวเตอร์นั้น ผู้ซื้อควรจะต้องศึกษาและหาข้อมูลเกี่ยวกับสินค้าให้พอมีความรู้อยู่บ้างในเบื้องต้นก็ยังดี และก่อนที่จะตัดสินใจซื้อเครื่องคอมพิวเตอร์กับร้านไหนควรหาข้อมูลร้านค้าดี ๆ เสียก่อน เลือกร้านที่ไว้ใจได้ และหากจะให้ดีควรเลือกร้านที่มีการบริการหลังการขายที่ดี อาจจะเลือกดูข้อมูลจากรีวิวต่าง ๆ หรือตามเว็บไซต์อื่น ๆ ประกอบการตัดสินใจด้วย หากพูดถึงคอมพิวเตอร์แล้ว คนที่ไม่มีข้อมูลสินค้า ไม่มีข้อมูลร้านเลย ไม่มีความรู้ใด ๆ เลย การเลือกซื้อสินค้าคงเป็นไปได้ยาก หากไม่มีร้านที่ไว้ใจได้คอยให้การดูแล หากมีปัญหาเหล่านี้ มาปรึกษาเราได้ที่ iHAVECPU ได้เลย ยินดีให้คำปรึกษา รับประกันบริษัทเราเปิดขายมามากกว่า 9 ปี !!</p>
