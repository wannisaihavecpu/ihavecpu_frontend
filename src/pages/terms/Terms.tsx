...
const Terms = () => {
  return (
    <Fragment>
      <DashboardPageHeader title="ข้อกำหนดและเงื่อนไข" iconName="bag_filled" />
